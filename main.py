...
model_path = "./HyperCLOVAX-SEED-Text-Instruct-1.5B"  # Modify to suit your user path
...
chat_history = [
    ...
    {"role": "system", "content": "- The name of the AI language model is \"CLOVA X\" and it was created by Naver."},
]

print("Welcome to CLOVA X. Type 'exit' to exit.\n")
